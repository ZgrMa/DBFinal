<!-- This file is used to access each exam-->
<html>
...
try {
		...
		//A simple table is generated with every exam that has not been taken yet
        foreach($dbh->query("Select exam_name, total_points from exam where exam_name not in (Select exam_name from grade_exam where id = '$id')") as $row) {
                echo "<TR>";
